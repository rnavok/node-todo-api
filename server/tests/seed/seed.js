...
const users = [
    {
        ...
        tokens : [{
            access : 'auth',
            token :   jwt.sign({_id : user1IDtoTest, access : 'auth'} ,process.env.JWT_SECRET).toString()
        }]
    },{
        _id : user2IDtoTest,
        email : '2@gmail.com',
        password : 'password2',
          tokens : [{
            access : 'auth',
            token :   jwt.sign({_id : user2IDtoTest, access : 'auth'} ,process.env.JWT_SECRET).toString()
        }]
    }
];
